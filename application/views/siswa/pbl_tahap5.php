...
#rekapTable, #reflectionTable { min-width: 720px !important; }
...
<div class="container-fluid">
  ...
  <div class="card shadow-sm border-0 mb-4 reflectionContainer">
    <div class="card-header bg-white py-3">
      <h5 class="mb-0 card-title text-success"><i class="bi bi-envelope-paper me-1"></i> Refleksi & Umpan Balik</h5>
      ...
      <form id="refleksiForm" autocomplete="off">
        ...
        <div class="modal-body bg-light">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control-plaintext border-bottom fw-bold" id="modalStudentName" readonly value="-">
          </div>

          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label fw-bold text-secondary">Catatan Refleksi Guru</label>
              <textarea name="teacher_reflection" class="form-control bg-white" rows="6" readonly disabled></textarea>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label fw-bold text-secondary">Umpan Balik Untuk Anda</label>
              <textarea name="student_feedback" class="form-control bg-white" rows="6" readonly disabled></textarea>
            </div>
          </div>
        </div>
