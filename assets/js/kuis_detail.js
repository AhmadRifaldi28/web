...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const config = {
    ...
    deleteMethod: 'POST', // Menggunakan POST untuk delete
    modalTitles: {
    ...
    /**
     * Dijalankan saat tombol 'Tambah' diklik (sebelum modal tampil)
     */
    onAdd: (form) => {
      // Pastikan form di-reset dan hidden ID dikosongkan
      form.reset();
      form.querySelector('#questionId').value = '';
      // Set quiz_id default (sudah ada di hidden field)
    }
  };
